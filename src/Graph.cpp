...
inline double bearingTo(double lat0, double lon0, double lat1, double lon1) {
...
inline double crossTrackDistance(double lat0, double lon0, double lat1, double lon1, double latq, double lonq) {
